            ...
            <div class="d-flex align-items-center" style="column-gap: 10px">
                ...
                <div class="d-flex align-items-center" style="column-gap: 5px">
                    <button type="button" class="btn btn-success px-3 btn-flex "
                        ...
                        data-bs-target="#addNewTeamMember">कर्मचारी थप्नुहोस्</button>
                </div>
            </div>
        </div>
                                ...
                                <td>
                                    <div class="d-flex gap-2 align-items-center">
                                        ...
                                        <button
                                            ...
                                            wire:click="edit({{ $employee->id }})" style="height: 20px;width:20px">
                                        ...
                                        <button
                                            ...
                                            onclick="confirmDelete({{ $employee->id }})" data-bs-toggle="tooltip"
                                        ...
                                        <button
                                            ...
                                            onclick="confirmChangeStatus({{ $employee->id }})" data-bs-toggle="tooltip"
...
@section('modal')
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header bg-info text-white">
                    <h1 class="modal-title fs-5" id="addNewTeamMemberLabel">नयाँ कर्मचारी थप्नुहोस्</h1>
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            <label for="name" class="form-label text-dark">कर्मचारीको नाम</label>
                            <input type="text" class="form-control translate-nepali" id="name" name="name"
                                placeholder="कर्मचारीको नाम यहाँ लेख्नुहोस्" wire:model="name">
                            @if ($errors->has('name'))
                        ...
                        <div class="mb-3">
                            <label for="profile_image" class="form-label text-dark">कर्मचारीको प्रोफाइल</label>
                        ...
                        <div class="mb-3">
                            <label for="position" class="form-label text-dark">कर्मचारीको पद</label>
                        ...
                        <div class="mb-3">
                            <label for="phone_no" class="form-label text-dark">कर्मचारीको फोन नम्बर</label>
                        ...
                        <div class="mb-3">
                            <label for="location" class="form-label text-dark">कर्मचारीको ठेगाना</label>
                        ...
                        <div class="mb-3">
                            <label for="status" class="form-label text-dark">कर्मचारीको स्थिति</label>
                        ...
                        <div class="mb-3">
                            <label for="gender" class="form-label text-dark">कर्मचारीको लिङ्ग</label>
                        ...
                        <div class="mb-3">
                            <label for="rank" class="form-label text-dark">कर्मचारीको रैंक</label>
    ...
    <div class="modal fade" wire:ignore.self id="updateTeamMember" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header bg-info text-white">
                    <h1 class="modal-title fs-5" id="updateTeamMemberLabel">नयाँ कर्मचारी थप्नुहोस्</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                        wire:click="resetFields"></button>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal" wire:click="resetFields">रद्द
                        गर्नुहोस्</button>
                    <button type="button" class="btn btn-success" wire:click="updateEmployee">सबमिट गर्नुहोस्</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="imageModalLabel">कर्मचारीको फोटो</h5>
...
@push('script')
    <div wire:ignore.self>
        <script>
            ...
            function confirmChangeStatus(employeeId) {
                Swal.fire({
                    title: "के तपाईं पक्का हुनुहुन्छ?",
                    text: "यो क्रिया पुनः फर्काउन सकिने छैन!",
                    icon: "warning",
                    ...
                    if (result.isConfirmed) {
                        @this.call('changeStatus', employeeId);
                    }
                });
