                        ...
                        <div class="table-responsive">
                            <div class="d-md-flex justify-content-between align-items-center py-2">
                                ...
                                <div class="mt-2 mt-md-0">
                                    <input type="text" id="amount_withdraw_date" class="form-control "
                                        wire:model.live="amount_withdraw_date" placeholder="नगद सङ्कलन मिति">
                                </div>
                            </div>
                                ...
                                <tbody>
                                    @if (count($withdrawTransactions) > 0)
                                        @foreach ($withdrawTransactions as $key => $withdraw)
                                            <tr wire:key="{{ $key }}">
                                                <td style="white-space: nowrap;">{{ $withdraw->nepali_count }}</td>
                                                <td style="white-space: nowrap;">{{ $withdraw->nepali_amount }}</td>
                                                @php
